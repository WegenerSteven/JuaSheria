...
export const chatDefaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    ...
    'Explain the Bill of Rights in Kenya',
    'What is the process of impeachment in Kenya?',
    'What are the functions of Parliament in Kenya?',
    'Explain the devolution of government in Kenya',
    'What are the duties of a Kenyan citizen?',
  ],
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Ask about Kenyan law or try an example',
